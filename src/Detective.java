...
public enum Detective implements PositionableObject {
    ...
    public static Detective[] placerDetective(){
        Detective.HOLMES.setPosition(new Position(1,0, Position.Sens.WEST, Position.Returned.NONE)); //On ne tient pas compte des Sens
        Detective.WATSON.setPosition(new Position(1,4,Position.Sens.EAST, Position.Returned.NONE)); //On ne tient pas compte des Sens
        Detective.TOBY.setPosition(new Position(4,2,Position.Sens.SOUTH, Position.Returned.NONE)); //On ne tient pas compte des Sens
        return values();
    }
